    ...
    >
      ...
      <div className="navbar__right">
        {isAuthenticated && user ? (
          <>
            <div
              className="navbar__balance"
              aria-label={`Balance: ${formatCents(balance)}`}
            >
              <svg
                className="navbar__balance-icon"
                viewBox="0 0 16 16"
                fill="none"
                aria-hidden="true"
              >
                ...
                />
                <path
                  d="M8 4.5v7M6 6.5c0-.83.9-1.5 2-1.5s2 .67 2 1.5-.9 1.5-2 1.5-2 .67-2 1.5.9 1.5 2 1.5"
                  stroke="currentColor"
                  strokeWidth="1.2"
                  strokeLinecap="round"
                />
            ...
            <div
              className="navbar__user-section"
              role="button"
              tabIndex={0}
